...
#   finding number of items in the list, sorting te list, adding/removing items, 
...
def main():
    ...
    print(dogs)
    print(doggy + "was remvoed from the front of the list.")
    ...
    dogs2 = dogs
    print("\nA list caan be copied into another list by setting one equal to the other:")
    print(dogs)
    print(dogs2)

    print("\nUse a FOR loop to give each dog in the same last name:")
    for i in range(len(dogs)):
        dogs[i] = dogs[i]+ " Mao" #Change Stevens to your last name
    print(dogs)
